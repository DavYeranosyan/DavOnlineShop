...
public class AddFragmentSecondList extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_add_second_list, container, false);

        firebaseStorage = FirebaseStorage.getInstance();

        addName = root.findViewById(R.id.addNameProductList2);
        addDescription = root.findViewById(R.id.addTextDescriptionList2);

        addImage = root.findViewById(R.id.addPhotoList2);
        ...
        add = root.findViewById(R.id.addBtnList2);
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                databaseReference = FirebaseDatabase.getInstance().getReference("list2").push();
